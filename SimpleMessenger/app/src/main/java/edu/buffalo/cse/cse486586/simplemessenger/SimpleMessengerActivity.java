...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            /*
            Sources Referred:
            https://stackoverflow.com/questions/10069059/is-it-possible-to-run-a-socket-server-and-socket-client-on-the-same-machine
            ...
            try
            {
                while (true)
                {
                    ...
                    {
                        // Use message to call onProgressUpdate()
                        publishProgress(message);
                        Log.i(TAG, "Message Received: " + message);
                        // Send Acknowledgement
                        server_output_stream.println("ACK");
                        Log.i(TAG, "Acknowledgment Sent.");
    ...
    private class ClientTask extends AsyncTask<String, Void, Void>  {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                // Send Message
                client_output_stream.println(msgToSend);
